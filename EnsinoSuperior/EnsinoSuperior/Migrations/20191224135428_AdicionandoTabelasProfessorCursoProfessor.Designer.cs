...
namespace EnsinoSuperior.Migrations
{
    ...
    [Migration("20191224135428_AdicionandoTabelasProfessorCursoProfessor")]
    partial class AdicionandoTabelasProfessorCursoProfessor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnsinoSuperior.Models.Infra.RegistrarNovoUsuarioViewModel", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EnsinoSuperior.Models.Infra.UsuarioDaAplicacao", b =>
                {
            ...
            modelBuilder.Entity("Modelo.Discente.CursoProfessor", b =>
                {
            ...
            modelBuilder.Entity("Modelo.Discente.Professor", b =>
                {
                    b.Property<long?>("ProfessorID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EnsinoSuperior.Models.Infra.UsuarioDaAplicacao")
                        .WithMany()
            ...
            modelBuilder.Entity("Modelo.Discente.CursoProfessor", b =>
                {
                    ...
                    b.HasOne("Modelo.Discente.Professor", "Professor")
                        .WithMany("CursosProfessores")
